...
from next_best_path.testers.nbp_planning import *

dir_path = os.path.abspath(os.path.dirname(__file__))
test_configs_dir = os.path.join(dir_path, "./configs/test/")
        
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Script to test a nbp model and show recontructed 3D scenes.')
    ...
    if args.config:
        ...
        params_name = "test_via_nbp_model.json"
    ...
    with torch.no_grad():
        test_nbp_planning(params_file=test_params.params_name,
                 ...
                 nbp_weights=test_params.nbp_weights)
